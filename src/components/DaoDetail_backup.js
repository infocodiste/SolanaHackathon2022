                        ...
                        <div className="right col-md-5">
                            <div style={{display: 'flex'}}>
                                    ...
                                    {finalData.length > 0 ?
                                        ...
                                        {mean = (Math. abs(finalData[0].percent_change_90d) + Math.abs(finalData[0].percent_change_60d) + Math.abs(finalData[0].percent_change_30d) + Math.abs(finalData[0].percent_change_24h)) /4}
                                        {deviation = Math.sqrt((Math.pow(finalData[0].percent_change_90d - mean),2) + (Math.pow(finalData[0].percent_change_60d - mean),2) + (Math.pow(finalData[0].percent_change_30d - mean),2) + (Math.pow(finalData[0].percent_change_24h - mean),2)/3)}
                                        {intermediateresult = ((1/deviation )+107 + (finalData[0].market_cap/10 + finalData[0].volume24h ))/100000000}
                                        {scaledresult = Math.log(intermediateresult)/5100}
                
                                        {result = scaledresult.toFixed(2)}
