export const daoData = [
    {
        ...
        "TokenAddress": "7gjNiPun3AzEazTZoFEjZgcBMeuaXdpjHq2raZTmTrfs",
        "TreasuryAddress": "0xe3997288987E6297Ad550A69B31439504F513267",
        "chain": [
            "SOL"
        ],
        "token": [
        ...
        "createdAt": {
            "$date": {
                "$numberLong": "1645008453410"
            }
        },
        "updatedAt": {
            "$date": {
                "$numberLong": "1651762843964"
            }
        },
        "twitterFollowers": {
            "$oid": "6230eafb8fcfaa196f9b301e"
        },
    ...
    },
    {
        ...
        "TokenAddress": "GJa1VeEYLTRoHbaeqcxfzHmjGCGtZGF3CUqxv9znZZAY",
        "TreasuryAddress": "0x0bB1810061C2f5b2088054eE184E6C79e1591101",
        "chain": [
            "SOL"
        ],
        "token": {
            "$oid": "623fc39617f99988906aa2a0"
        },
        "live": true,
        "createdAt": {
            "$date": {
                "$numberLong": "1645008452375"
            }
        },
        "updatedAt": {
            "$date": {
                "$numberLong": "1651674597361"
            }
        },
        ...
        "tokenChange7d": -16.61,
        "description": "<p>Decentralized exchange infrastructure for the internet</p>",
        "verified": false
    },
    {
        "name": "MeanFi",
        ...
        "token": null,
        "live": true,
        "TokenAddress": "MEANeD3XDdUmNMsRGjASkSWdC8prLYsoRJ61pPeHctD",
        "TreasuryAddress": "GNHnU2infXYKu1HvDfNWrpNFNwz8CubrudVNgTZz8LSf",
        "createdAt": {
            "$date": {
                "$numberLong": "1644435518852"
            }
        },
        "updatedAt": {
            "$date": {
                "$numberLong": "1651763217903"
            }
        },
        "twitterFollowers": {
            "$oid": "6230ec788fcfaa196f9b32b6"
        },
    ...
    },
    {
        ...
        "TreasuryAddress": "7jt7Hw1iypXN3otudBeTPkY2K4yotWMTegWeAxnt1h3c",
        "chain": [
            "SOL"
        ],
        "token": null,
        ...
        "createdAt": {
            "$date": {
                "$numberLong": "1645008454441"
            }
        },
        "updatedAt": {
            "$date": {
                "$numberLong": "1651763424061"
            }
        },
        "twitterFollowers": {
            "$oid": "6230ed4d8fcfaa196f9b34ae"
        },
